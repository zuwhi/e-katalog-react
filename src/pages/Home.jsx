...
const Home = () => {
  return (
    <>
     <Seo title="E Katalog Mebel Jepara" description={"Membantu mu dalam memilih dan menentukan mebel jepara yang sesuai dengan keinginanmu"} canonical={"https://e-katalog-jepara.vercel.app/"} schemaMarkup={{ "@type": "WebSite", url: "https://e-katalog-jepara.vercel.app/", name: "E Katalog Mebel Jepara", description: "Membantu mu dalam memilih dan menentukan mebel jepara yang sesuai dengan keinginanmu" }}   />
              ...
              <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-20">
                <div className="flex items-center">
                  <h1 className="font-light text-gray-500 text-xl md:text-xl leading-normal mb-10">
                    Elegan, Fungsional, dan Berkualitas – Hanya di E-Katalog Mebel Jepara! Jelajahi koleksi mebel berkualitas tinggi dengan desain modern, klasik, hingga minimalis. Temukan berbagai pilihan furnitur untuk rumah dan kantor
